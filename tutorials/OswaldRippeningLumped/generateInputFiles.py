...
setInputVariable('inputFiles/'+DDfile,'dxMax','0.5') # max nodal displacement for when timeSteppingMethod=adaptive
...
setInputVariable('inputFiles/'+DDfile,'Nsteps','200')  # number of simulation steps
...
pf.boxScaling=np.array([1500,1500,1500]) # length of box edges in Burgers vector units
...
# setInputVariable('inputFiles/'+microstructureFile1,'loopSides','20')
# setInputVariable('inputFiles/'+microstructureFile1,'isVacancyLoop','1')
# setInputVector('inputFiles/'+microstructureFile1,'loopCenters',np.array([0,0,0]),'set of grain IDs where loops are allowed. Use -1 for all grains')
