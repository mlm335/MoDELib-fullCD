...
setInputVariable('inputFiles/'+materialFile,'doseRate_dpaPerSec','1e-7') # [dpa/s] irradiation dose rate
setInputVariable('inputFiles/'+materialFile,'mobileSpeciesSurvivingEfficiency','0.01') # Surviving efficiencyr
setInputVector('inputFiles/'+materialFile,'mobileSpeciesCascadeFractions',np.array([1.0,0.6,0.3212,0.0788]),'') # [-] 
setInputVector('inputFiles/'+materialFile,'n_min',np.array([8,4,4,4]),'') # [-] Minimal immobile per node
...
setInputVector('inputFiles/'+materialFile,'initLoopSinks_SI',np.array([0,0,0,0,1e-50,1e-50,1e-50,1e-50]),'') # [m^-3] and [-] for initial loop sinks
setInputVector('inputFiles/'+materialFile,'loopClusterFraction',np.array([0,0.3333,0.3333,0.3333]),'') # [-] route lost i+3i/2i+2i content into loop families
setInputVariable('inputFiles/'+materialFile,'loopClusterNucDefects','4') # [-] loop-loop Avrami capture factor
setInputVector('inputFiles/'+materialFile,'loopCascadeFraction',np.array([1e-7,5e-6,5e-6,5e-6]),'')  # [-] direct cascade loop seed per [c,a1,a2,a3]
