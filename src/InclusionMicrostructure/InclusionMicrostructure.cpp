...
namespace model
{
    ...
    template<int dim>
    typename InclusionMicrostructure<dim>::VectorISize InclusionMicrostructure<dim>::immobileClusters(const VectorDim&,const NodeType* const,const ElementType* const,const SimplexDim* const) const
    {
